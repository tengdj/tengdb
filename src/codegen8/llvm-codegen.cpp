...
void initDecodeBitWidth(LlvmCodeGen *gen){
	...
	elements.push_back(gen->getConstant(32,2));//1
	elements.push_back(gen->getConstant(32,0));//2
	elements.push_back(gen->getConstant(32,4));//3
	elements.push_back(gen->getConstant(32,0));//4
	elements.push_back(gen->getConstant(32,0));//5
	elements.push_back(gen->getConstant(32,0));//6
	elements.push_back(gen->getConstant(32,8));//7
	elements.push_back(gen->getConstant(32,0));//8
	elements.push_back(gen->getConstant(32,0));//9
	elements.push_back(gen->getConstant(32,0));//10
	elements.push_back(gen->getConstant(32,0));//11
	elements.push_back(gen->getConstant(32,0));//12
	elements.push_back(gen->getConstant(32,0));//13
	elements.push_back(gen->getConstant(32,0));//14
	elements.push_back(gen->getConstant(32,16));//15
	elements.push_back(gen->getConstant(32,0));//16
	elements.push_back(gen->getConstant(32,0));//17
	elements.push_back(gen->getConstant(32,0));//18
	elements.push_back(gen->getConstant(32,0));//19
	elements.push_back(gen->getConstant(32,0));//20
	elements.push_back(gen->getConstant(32,0));//21
	elements.push_back(gen->getConstant(32,0));//22
	elements.push_back(gen->getConstant(32,24));//23
	elements.push_back(gen->getConstant(32,0));//24
	elements.push_back(gen->getConstant(32,0));//25
	elements.push_back(gen->getConstant(32,0));//26
...
void initClosestBits(LlvmCodeGen *gen){
	...
	elements.push_back(gen->getConstant(32,1));//0
	elements.push_back(gen->getConstant(32,1));//1
	elements.push_back(gen->getConstant(32,2));//2
	elements.push_back(gen->getConstant(32,3));//3
	elements.push_back(gen->getConstant(32,4));//4
	elements.push_back(gen->getConstant(32,5));//5
	elements.push_back(gen->getConstant(32,6));//6
	elements.push_back(gen->getConstant(32,7));//7
	elements.push_back(gen->getConstant(32,8));//8
	elements.push_back(gen->getConstant(32,9));//9
	elements.push_back(gen->getConstant(32,10));//10
	elements.push_back(gen->getConstant(32,11));//11
	elements.push_back(gen->getConstant(32,12));//12
	elements.push_back(gen->getConstant(32,13));//13
	elements.push_back(gen->getConstant(32,14));//14
	elements.push_back(gen->getConstant(32,15));//15
	elements.push_back(gen->getConstant(32,16));//16
	elements.push_back(gen->getConstant(32,17));//17
	elements.push_back(gen->getConstant(32,18));//18
	elements.push_back(gen->getConstant(32,19));//19
	elements.push_back(gen->getConstant(32,20));//20
	elements.push_back(gen->getConstant(32,21));//21
	elements.push_back(gen->getConstant(32,22));//22
	elements.push_back(gen->getConstant(32,23));//23
	elements.push_back(gen->getConstant(32,24));//24
